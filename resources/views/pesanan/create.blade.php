                    ...
                    <table id="detail-pesanan" class="table table-bordered">
                        ...
                        <tbody data-repeater-list="detail_transaksi">
                            <tr data-repeater-item>
                                ...
                                <td>
                                    <div class="col-md-12">
                                        <input readonly class="form-control form-control-solid uang harga" name="harga"
                                            placeholder="Harga" id="harga" />
                                    </div>
                                </td>
                                <td>
                                    <div class="col-md-12">
                                ...
                                <td>
                                    <div class="col-md-12">
                                        <input readonly class="form-control form-control-solid uang jumlah" name="jumlah"
