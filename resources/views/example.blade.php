        ...
        <div class="row">
            <div class="col-lg-5 mb-3 mb-lg-5">
                ...
                <div class="card h-100">
                    ...
                    <!-- Body -->
                    <div class="card-body">
                        <p>See and talk to your users and leads immediately by importing your data into the
                            Front
                        ...
                        <ul class="list-group list-group-flush list-group-no-gutters">
                            ...
                            <li class="list-group-item"><span class="small text-muted">Or you can <a class="link"
                                        href="#">sync data to Front Dashboard</a> to
                                    ensure
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress rounded-pill mb-2">
                            ...
                            <div class="progress-bar opacity-50" role="progressbar" style="width: 33%"
                                ...
                                data-bs-placement="top" title="Net volume from sales">
                            </div>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="hs-has-sub-menu nav-item">
                                    <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle "
                                        href="#" role="button"><i class="bi-files-alt dropdown-item-icon"></i>
                                        Pages</a>
                                    ...
                                    <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                                        ...
                                        <a class="dropdown-item " href="landing.html" data-placement="left">Landing
                                            Page <span class="badge bg-info rounded-pill ms-1">New</span></a>
                                    </div>
                                    <!-- End Mega Menu -->
                                </li>
                                <!-- End Pages -->
