...
const HSCore = {
    ...
    init: function () {
        ...
        document
            .querySelectorAll("[data-bs-popover-dark]")
            .forEach(function (t) {
 ...
 */ (HSCore.components.HSMask = {
     ...
     */ (HSCore.components.HSTomSelect = {
            ...
            for (let e = 0; e < t.collection.length; e += 1) {
                ...
                t.collection[e].hasOwnProperty("$initializedEl") ||
                    ((i = t.collection[e].options),
                        ...
                        i.searchInDropdown &&
                        (i.plugins = [...i.plugins, "dropdown_input"]),
                            ...
                            this.hook("after", "setup", function () {
                                (this.$menu = this.dropdown_content.parentElement),
                                    ...
                                    window.addEventListener("scroll", () =>
                                        (function (t) {
                                            const e =
                                                t.$menu.getBoundingClientRect();
                                            e.bottom > window.innerHeight
                                                ? (t.$menu.style.top = `-${t.$menu.clientHeight + 10
                                                    }px`)
                                                : e.top < 0 &&
                                                (t.$menu.style.top = null);
                                        })(this)
                                    );
                            });
                        }),
                        ...
                        i.hideSearch &&
                        t.hideSearch(t.collection[e].$initializedEl, i),
                        i.disableSearch &&
                        t.disableSearch(t.collection[e].$initializedEl, i),
                        i.width && t.width(t.collection[e].$initializedEl, i),
                        i.singleMultiple &&
                        t.singleMultiple(t.collection[e].$initializedEl, i),
                        i.hidePlaceholderOnSearch &&
                        t.hidePlaceholderOnSearch(
                            t.collection[e].$initializedEl,
                            i
                        ),
                        i.create &&
                        t.openIfEmpty(t.collection[e].$initializedEl, i),
                        i.hideSelectedFromField &&
                        t.hideSelectedFromField(
                            t.collection[e].$initializedEl,
                            i
                        ),
                        i.dropdownWidth &&
                        t.dropdownWidth(t.collection[e].$initializedEl, i),
        ...
        singleMultiple(t, e) {
            ...
            const i = (
                ...
                n = (e) => {
                    ...
                    return (t.wrapper.querySelector(
                        ".ts-selected-count"
                    ).innerHTML = e);
                };
            t.items.length &&
        ...
        dropdownWidth(t, e) {
            t.on(
                "dropdown_open",
                () => (t.$menu.style.width = e.dropdownWidth)
            );
        },
        width(t, e) {
            ...
            (e = Object.assign(
                ...
                this.collection.push({
                    ...
                    options: Object.assign({}, e, {
                        ...
                        text: (i) => {
                            var o = JSON.parse(
                                i.getAttribute("data-hs-clipboard-options")
                            );
                            return (
     ...
     */ (HSCore.components.HSDatatables = {
            ...
            for (let o = 0; o < t.collection.length; o += 1) {
                ...
                if (!t.collection[o].hasOwnProperty("$initializedEl")) {
                    ...
                    var e = new $.fn.dataTable.Api(l),
                        i = function () {
                            ...
                            o.wrap(
                                ...
                                n.info.totalQty &&
                                $(n.info.totalQty).html(t.recordsDisplay),
                                n.scrollY &&
                                l
                                    .find(
                    ...
                    i(),
                        ...
                        t.customPagination(
                            l,
                            t.collection[o].$initializedEl,
                            n
                        ),
                        t.customSearch(l, t.collection[o].$initializedEl, n),
                        n.isColumnsSearch &&
                        t.customColumnsSearch(
                            l,
                            t.collection[o].$initializedEl,
                            n
                        ),
                        ...
                        n.select &&
                        t.select(n.select, t.collection[o].$initializedEl);
                }
            }
        },
        ...
        customColumnsSearch: function (t, e, i) {
            ...
            e.columns().every(function () {
                ...
                o.isColumnsSearchTheadAfter &&
                    $(".dataTables_scrollFoot").insertAfter(
        ...
        select: function (t, e) {
            $(t.classMap.checkAll).on("click", function () {
                ...
                e
                    .on("select", function () {
                        $(t.classMap.counter).text(
                            e.rows(".selected").data().length
                        ),
                            e.rows().data().length !==
                                e.rows(".selected").data().length
...
const validators = {
    ...
    HSBsValidation = {
            ...
            Array.prototype.slice.call(t).forEach((t) => {
                ...
                e &&
                    (t.addEventListener("input", (t) =>
                        this.updateFieldStete(t.target)
                    ),
        ...
        checkFieldsState(t) {
            Array.prototype.slice
                .call(t)
                .forEach((t) => this.updateFieldStete(t));
        },
        updateFieldStete(t) {
            const e = t.closest("[data-hs-validation-validate-class]");
            e &&
...
(HSCore.components.HSChartJS = {
    ...
    (HSCore.components.HSChartMatrixJS = {
        ...
        defaults: {
            ...
            options: {
                ...
                plugins: {
                    legend: !1,
                    tooltip: { enabled: !1, mode: "nearest" },
                },
                gradientPosition: { x0: 0, y0: 0, x1: 0, y1: 0 },
            },
        },
                ...
                t.data.datasets.forEach(function (e) {
                    e.backgroundColor = function (e) {
                        var i = e.dataset.data[e.dataIndex].v,
                            o =
                                ((t.options.matrixBackgroundColord.hasOwnProperty(
                                    ...
                                    ? t.options.matrixBackgroundColord
                                        .additionToValue
                                    : 5) +
                                    i) /
                        ...
                        return 0 == i.toFixed() &&
                            ...
                            ? Chart.helpers
                                .color(
                                    t.options.matrixBackgroundColord.nullColor
                                )
                                .rgbString()
                            : Chart.helpers
        ...
        legend(t) {
            if (t.options.hasOwnProperty("matrixLegend")) {
                for (
                    ...
                    t.data.datasets[0].data[o].v < e &&
                        (e = t.data.datasets[0].data[o].v),
                ...
                var n = [],
                    ...
                    a = document.querySelector(
                        t.options.matrixLegend.container
                    );
                ...
                (l.options.plugins.tooltip.external = function (t) {
                    ...
                    if (
                        ...
                        i.forEach(function (t) {
                            ...
                            (s += "</div>"),
                            (e.querySelector(".hs-chartjs-tooltip").innerHTML =
                                s);
                    }
                    ...
                    (e.style.opacity = 1),
                        ...
                        (e.style.transition =
                            l.options.plugins.tooltip.transition);
                }),
                l
            );
        },
     ...
     */ (HSCore.components.HSQuill = {
        ...
        toolbarBottom: function (t, e) {
            if (t.toolbarBottom) {
                ...
                if (
                    (i.parentElement.classList.add("ql-toolbar-bottom"),
                        t.attach)
                ) {
                    document
        ...
        init: function (t, e) {
            if (
                ...
                var i = this.$el.hasAttribute("data-hs-leaflet-options")
                    ? JSON.parse(
                        this.$el.getAttribute("data-hs-leaflet-options")
                    )
                    : {};
                ...
                if (
                    (o.setView(
                        this.settings.map.coords,
                        this.settings.map.zoom
                    ),
                        L.tileLayer(
                            this.settings.layer.token,
                            this.settings.layer
                        ).addTo(o),
                        this.settings.marker)
                )
                    for (var n = 0; n < this.settings.marker.length; n++) {
                        this.settings.marker[n].icon = L.icon(
                            this.settings.marker[n].icon
                        );
                        let t = L.marker(
            ...
            for (let e = 0; e < t.collection.length; e += 1) {
                ...
                t.collection[e].hasOwnProperty("$initializedEl") ||
                    ((i = t.collection[e].options),
                        (o = t.collection[e].$el),
                        i.isViewportInit &&
                        ((i.mutatedValue = i.value), (i.value = 0)),
                        t.setId(o, i),
    ...
    (HSCore.components.HSList = {
                ...
                if (40 === s.which)
                    s.preventDefault(),
                        ...
                        (a = i.list.querySelector(".active"))
                            ...
                            ((r = a.nextElementSibling).classList.add(
                                "active"
                            ),
                    ...
                    if (
                        ...
                        if (a.previousElementSibling)
                            (r = a.previousElementSibling).classList.add(
                                "active"
                            ),
                                l.classList.remove("active"),
                                (l = r),
                        ...
                        (l = i.list.firstChild.parentNode).classList.add(
                            "active"
                        );
        ...
        searchMenuShow: function (t, e, i) {
            const o = this;
            if (
                (o.helpers.fadeIn(i.list, e.searchMenuDelay),
                    !i.visibleItems.length)
            ) {
                var n = o.helpers.show(
                    document.querySelector(e.empty).cloneNode(!0)
                );
            ...
            for (let e = 0; e < t.collection.length; e += 1) {
                ...
                t.collection[e].hasOwnProperty("$initializedEl") ||
                    ((i = t.collection[e].$el),
                        ...
                        o.searchMenu &&
                        t.helpers.hide(t.collection[e].$initializedEl.list),
        ...
        _init: function () {
            ...
            for (let e = 0; e < t.collection.length; e += 1) {
                const i = t.collection[e].options,
                    o = t.collection[e].$el;
                i.disablePrevDates &&
                    (i.minDate = moment().format("MM/DD/YYYY"));
